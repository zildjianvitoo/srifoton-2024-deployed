    ...
    <div className="flex flex-col gap-[200px]">
      ...
      <div ref={workshopRef}>
        <Flashcards id="talkshow-option" title="talkshow options">
          ...
          >
            <p>
              Talkshow SRIFOTON "Effective Ways to Build and Maintain a Personal
              Brand in the Digital Era" membahas membangun citra positif di
              media sosial dan dampaknya pada kehidupan profesional.
            </p>
            <Benefits>
              <p>E-Sertifikat</p>
              <p>Menambah relasi</p>
      ...
      <QNA id="workshop-qna" title="workshop qna">
        <SpeechBubble id="speech1" question="Bagaimana cara mendaftar?">
          Silakan klik tombol "Register" pada acara yang ingin Anda ikuti,
          kemudian ikuti langkah-langkah untuk menyelesaikan proses pendaftaran.
        </SpeechBubble>
