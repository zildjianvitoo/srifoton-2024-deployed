      ...
      <div className="flex flex-col gap-8 text-primary md:gap-16">
        ...
        <div className="flex flex-col items-center gap-[5%] md:flex-row">
          ...
          >
            ...
            bidangnya, bertema "Kickstart Your Web Development Journey" dengan
            pembekalan materi pemrograman dan live coding untuk pengembangan
            situs web dasar.
          </SectionContent>
        ...
        <div className="flex flex-col items-center gap-[5%] md:flex-row">
          <div className="z-10 flex aspect-[585/518] w-2/5 min-w-[40%] items-center">
            <Image
          ...
          >
            ...
            Maintain a Personal Brand in the Digital Era," dengan fokus pada
            membangun personal branding digital, membentuk citra positif di
