        ...
        <section className="flex md:grid flex-col md:grid-rows-4 lg:grid-rows-3 grid-flow-col md:justify-stretch lg:justify-between z-10 relative gap-12 lg:gap-y-0 mt-[80vw] md:mt-[33vw] lg:mt-20">
          ...
          <div id="filosofi1" className={cn(text, div)}>
            <div className={innerDiv}>
              ...
              <figure className="hidden lg:block relative">
                <svg xmlns="http://www.w3.org/2000/svg" width="319" height="22" viewBox="0 0 319 22" fill="none" className="absolute left-[2vw] min-[1650px]:left-0 bottom-[3.5vw] min-[1650px]:bottom-[4vw] w-[15vw] min-[1650px]:w-[20vw]">
          ...
          <div id="filosofi2" className={cn(text, div, "md:row-span-2 lg:row-span-1")}>
            <div className={innerDiv}>
              ...
              <figure className="hidden lg:block relative">
                <svg width="453" height="114" viewBox="0 0 453 114" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute left-[1.5vw] min-[1650px]:left-[0.5vw] bottom-[-1.5vw] min-[1650px]:bottom-[1vw] w-[20vw] min-[1650px]:w-[25vw]">
          ...
          <div id="filosofi3" className={cn(text, div)}>
            <div className={innerDiv}>
              ...
              <figure className="hidden lg:block relative order-first">
                <svg xmlns="http://www.w3.org/2000/svg" width="178" height="146" viewBox="0 0 178 146" fill="none" className="absolute left-[-11vw] top-[-1.25vw] min-[1650px]:top-[1vw] w-[8.5vw] min-[1650px]:w-[10vw]">
          ...
          <div id="filosofi4" className={cn(text, div)}>
            <div className={innerDiv}>
              ...
              <figure className="hidden lg:block relative order-first">
                <svg xmlns="http://www.w3.org/2000/svg" width="255" height="185" viewBox="0 0 255 185" fill="none" className="absolute left-[-14vw] min-[1650px]:left-[-15.5vw] top-[1vw] w-[12vw] min-[1650px]:w-[15vw]">
          ...
          <div id="filosofi5" className={cn(text, div)}>
            <div className={innerDiv}>
              ...
              <figure className="hidden lg:block relative order-first">
                <svg xmlns="http://www.w3.org/2000/svg" width="250" height="22" viewBox="0 0 250 22" fill="none" className="absolute left-[-14vw] min-[1650px]:left-[-15.5vw] top-[1vw] w-[12vw] min-[1650px]:w-[15vw]">
