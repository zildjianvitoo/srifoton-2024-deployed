  ...
  return (
    <section id="mascot">
      <div className="text-whtc-100">
        ...
        <figure className="relative left-[25%] top-[7vw] z-0 md:left-[37%] lg:top-[12vw]">
          <Image
            src="/img/mascot2.png"
            alt="mascot"
            width={893}
            height={1339}
            className="absolute w-1/2 md:w-[27.5%]"
          />
        </figure>
        <section className="relative z-10 mt-[80vw] flex grid-flow-col flex-col gap-12 md:mt-[33vw] md:grid md:grid-rows-4 md:justify-stretch lg:mt-20 lg:grid-rows-3 lg:justify-between lg:gap-y-0">
          <CardCrook
            outerClassName="w-[50vw] md:w-[18.2vw] h-fit scale-x-[-1] md:justify-self-center lg:justify-self-end self-center md:self-center lg:self-start lg:-mr-[25%] md:col-span-2 lg:col-span-1"
            innerClassName="text-[5vw] md:text-[2.6vw] py-[2vw] !font-monument h-fit leading-10"
          >
            <div className="mx-auto scale-x-[-1] text-black-200">CLUENO</div>
          </CardCrook>
          <div id="filosofi1" className={cn(text, div)}>
            <div className={innerDiv}>
              <h1 className={h1}>
                Keahlian dan <br /> Ketelitian
              </h1>
          ...
          >
            ...
            <ul className="grid list-inside list-disc gap-2">
              <li>
                Morning Blue: Ketenangan dan kepercayaan diri dalam mengatasi
                masalah.
              </li>
              <li>
                Shadow: Kemampuan bekerja di balik layar, menangani tantangan
                tersembunyi.
              </li>
              <li>
                Raisin Black: Ketegasan dan keandalan dalam situasi kompleks.
              </li>
              <li>
                White Chocolate: Kemurnian niat dan kejujuran dalam pekerjaan.
              </li>
            </ul>
          </div>
          <div id="filosofi3" className={cn(text, div)}>
            <div className={innerDiv}>
              ...
              <figure className="relative order-first hidden lg:block">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="178"
                  height="146"
