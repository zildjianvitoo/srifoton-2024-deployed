  ...
  return (
    <section id={id} className="
      ...
      gap-8 md:gap-12 lg:gap-16 2xl:gap-[85px]">
        ...
        <div className="aspect-[745/705] lg:min-w-[400px] 2xl:min-w-[550px] min-[1920px]:min-w-[745px] flex items-center relative">
          <figure className="
            flex mx-auto
            w-[65%] lg:w-[230px] 2xl:w-[500px]">
            <Image
              src={src}
              alt={`${id}-image`}
              width={500}
              height={500}
              className="aspect-square flex object-contain"
            />
          </figure>
          { card1title &&
            <div className="flex flex-col absolute p-3 xl:p-6 gap-2 xl:gap-4 left-0 bottom-0 max-w-[200px] min-[1920px]:max-w-[353px] bg-[#fff9f1]">
              <h1 className="font-monument font-normal text-sm sm:text-base lg:text-sm min-[1920px]:text-2xl">{card1title}</h1>
              <p className="font-ponnala font-normal text-xs sm:text-sm lg:text-xs min-[1920px]:text-xl">{card1content}</p>
            </div>
          }
          { card2title &&
            <div className="flex flex-col absolute p-3 xl:p-6 gap-2 xl:gap-4 right-0 top-0 max-w-[200px] min-[1920px]:max-w-[353px] bg-[#fff9f1]">
              <h1 className="font-monument font-normal text-sm sm:text-base lg:text-sm min-[1920px]:text-2xl">{card2title}</h1>
              <p className="font-ponnala font-normal text-xs sm:text-sm lg:text-xs min-[1920px]:text-xl">{card2content}</p>
            </div>
          }
        </div>

        <div className="
          flex flex-col text-center lg:text-start w-full sm:w-auto
