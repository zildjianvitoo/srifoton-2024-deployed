      ...
      <section className="flip-card aspect-[1208/615]">
        <div className="flip-card-inner font-monument text-black">
          <div className="flip-card-front flex rounded-[1.5625vw] bg-[#fff9f1] uppercase">
            <Image src={src2} alt="Avatar" width={276} height={244} className="aspect-[276/244] object-contain !w-[22.848%] !right-[3.642%] !top-[7.8%] absolute z-10"/>
            ...
            <div className="aspect-[1208/385] relative self-end flex w-full pt-[2.5%] pb-[3%] px-[4.139%] gap-9">
              <Image src={src1} alt="Avatar" width={309} height={309} className="aspect-[1/1] !w-[25.58%] object-cover object-top bottom-0 border-8 border-[#868365] bg-[#363330]"/>
          ...
          <div className="flip-card-back rounded-[1.5625vw] !pt-[3.887%] !pb-[10.53%] bg-[#fff9f1] grid justify-items-center">
            <Image src={src1} alt="Avatar" width={200} height={200} className="aspect-[1/1] !w-[16.55%] mb-[1.5%] object-cover object-top border-4 border-[#868365] bg-[#363330]"/>
            <p className="uppercase text-[1.822vw] mb-[1.5%]">{name}</p>
            <div className="font-ponnala mx-[3.64%] text-[1.3vw] leading-[120%] text-center mb-[1.5%]">{children}</div>
